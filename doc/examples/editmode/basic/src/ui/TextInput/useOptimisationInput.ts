type UseOptimisationControlType= (
    {onChange, value, inputRef}: {onChange: (value: any) => void, value: any, inputRef: React.MutableRefObject<any>}
    ) => {onChangeOptimized: (e: any) => void, onBlurOptimized: (e: any) => void}

export const useOptimisationInput: UseOptimisationControlType = (props) => {
