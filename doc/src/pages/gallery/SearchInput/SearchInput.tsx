...
import {MyForm} from "examples/gallery/SearchInput/src/forms/MyForm/MyForm";
    ...
    return (
      <div className={styles.container}>
        ...
        <div className="formmod__source">
          <a href="https://github.com/nickorsk2017/formMOD/raw/master/doc/examples/gallery/SearchInput/formMOD-searchInput.zip">Download example source</a>/
          <a target="_blank" href="https://github.com/nickorsk2017/formMOD/tree/master/doc/examples/gallery/SearchInput">See example source</a>
        </div>
